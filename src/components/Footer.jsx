    ...
    <footer className="bg-gray-900 text-gray-300 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="text-2xl font-bold text-white mb-2">KE</div>
            <p className="text-sm text-gray-400">
              {language === 'en'
                ? 'Full Stack Software Developer & Testing Expert'
                : 'Desarrollador de Software Full Stack y Experto en Pruebas'}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="p-2 bg-gray-800 rounded-lg hover:bg-blue-600 transition-smooth"
                title="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-smooth"
                title="GitHub"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <p className="text-center text-xs text-gray-500 mt-2">
            {language === 'en'
              ...
              : 'Diseñado y Construido con React, Vite y Tailwind CSS'}
          </p>
        </div>
      </div>
    </footer>
